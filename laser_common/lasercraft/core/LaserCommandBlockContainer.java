...
public class LaserCommandBlockContainer extends Container {

    protected LaserCommandBlockTileEntity tileEntity;

    public LaserCommandBlockContainer(InventoryPlayer inventoryPlayer, LaserCommandBlockTileEntity te) {
        tileEntity = te;
